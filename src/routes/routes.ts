...
const models: TsoaRoute.Models = {
    "IQueryRequest": {
        ...
        "properties": {
            ...
            "servicePoint": { "dataType": "string", "required": true },
        },
...
export function RegisterRoutes(app: express.Express) {
    ...
    // ###########################################################################################################
    app.get('/api/v1/schema/effdtQry/:tableName/:prefix',
        function(request: any, response: any, next: any) {
            const args = {
                req: { "in": "request", "name": "req", "required": true, "dataType": "object" },
                tableName: { "in": "path", "name": "tableName", "required": true, "dataType": "string" },
                prefix: { "default": "A", "in": "path", "name": "prefix", "required": true, "dataType": "string" },
            };
            ...
            const promise = controller.getEffdtQuery.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/api/v1/schema/listTemplate',
        function(request: any, response: any, next: any) {
            const args = {
                body: { "in": "body", "name": "body", "required": true, "ref": "IQueryRequest" },
            };
            ...
            const promise = controller.listTemplate.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/api/v1/schema/upsertTemplate',
        function(request: any, response: any, next: any) {
            const args = {
                req: { "in": "request", "name": "req", "required": true, "dataType": "object" },
                body: { "in": "body", "name": "body", "required": true, "ref": "IQueryRequest" },
            ...
            const promise = controller.getInsUpdRollfwdQuery.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/api/v1/growtech/palmplants',
        function(request: any, response: any, next: any) {
            const args = {
                req: { "in": "request", "name": "req", "required": true, "dataType": "object" },
            };
